...
#my attempt
shop2<- function (eggs2) {
  if (eggs2 == TRUE) {
    n.milk2 <-6} else {
  n.milk2 <- 1}
  paste0 ("Here's the milk. I bought ", n.milk2, ".")}
...
#milk yes eggs no
case0 <- shop2 (TRUE, FALSE)
paste0 ("Here's the milk. I bought ", case0, ".")

#milk yes egg yes
case1 <- shop2 (TRUE, TRUE)
...
shop3 <- function (milk,eggs) {
 if (milk == TRUE && eggs == TRUE) {
  ...
  paste0 ("I bought ", n.milk, " milk and ", n.egg, " eggs.")
}

case10 <- shop3 (TRUE, TRUE)
case10

case11 <- shop3 (TRUE, FALSE)
case11
```
...
#load in library tidyverse
library(tidyverse)

# Write a function that does exactly the same thing as shop3, but with less redundancy
shop4 <- function (milk) {
  if_else (milk == TRUE, n.milk <-1, n.milk <- 0)
}
shop5<- function (eggs) {
  if_else (eggs == TRUE, n.eggs <-6, n.eggs <- 0)
}
paste0 ("I bought ", shop4(TRUE), " milk and ", shop5(TRUE), " eggs.")
...
```{r}
#a carton of milk & a dozen eggs
shop6 <- function (milk) {
  if_else (milk == TRUE, n.milk <- 1, n.milk <- 0)
}
shop7 <- function (eggs) {
  if_else (eggs == TRUE, n.eggs <- 12, n.eggs <- 0)
}
paste0 ("I bought ", shop6 (TRUE), " milk and ", shop7 (TRUE), " eggs.")

#A carton of milk and a dozen eggs only if the store has both.
shop8 <- function (milk, eggs) {
  if (milk ==TRUE && eggs == TRUE) {
    n.milk <- 1
    n.eggs <-12
  } else  {
...
#Neither milk or eggs then a loaf of bread
shop9 <- function (milk, eggs) {
  if (milk == FALSE && eggs == FALSE) {
    n.milk <- 0
    n.eggs <- 0
    n.bread <-1
  } else {
  ...
  paste0 ("I bought ", n.milk, " milk,", n.eggs, " eggs and ", n.bread, " loaf of bread.")
}
shop9 (FALSE, FALSE)
```
