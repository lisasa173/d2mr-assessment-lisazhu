...
Name: Xiaozhuang (Lisa) Zhu

CNetID: lisazhu

Section: 1

Mini-project title: LZhelloworld_mini

Submission date: Jan 26, 2025

Project GitHub subdirectory URL: https://github.com/lisasa173/d2mr-assessment-lisazhu/tree/main/06_r-programming/01_hello-world
...
1.  Create and maintain a repo with sensible organization and naming conventions
    ...
    3.  Does not have duplicate/redundant elements
        ...
        -   [] Objective met
        -   Grader comments: A separated repository is needed to meet GitHub objectives since assessment is largely maintained by Dr. Dowling.
...
5.  Find, install, require, and load R packages
    ...
    2. Uses more than one function to install/load/require packages
        ...
        -   [*] Unique objective attempt
        -   [x] Objective met
        -   Grader comments: I checked the objectives met by [ x ]
...
22. Create and effectively use code chunks following best practices
    ...
    4.  Chunks are distributed throughout the manuscript, sensibly placed near the text they support
        ...
        -   [*] Unique objective attempt
        -   [ ] Objective met
        -   Grader comments: It's hard to show that you followed the practices since there's only one chunk in the file. 
                For this work, you could split the codes into three chunks: loading the libraries, define the function, and run tests.
...
23. Use code chunks to set up a quarto document
    ...
    4. Organizes setup chunks sensibly
        ...
        -   [*] Unique objective attempt
        -   [ ] Objective met
        -   Grader comments: The provided code does not source any external .R scripts or read in data from external sources. 
                There is no explicit setting of preferences or options, which refers to things like `echo`.
...
26. Create and maintain a quarto document YAML header
    ...
    1. Includes all necessary metadata, output options, and formatting options necessary to render an APA styled document (or other specified style if appropriate for the project)
        ...
        -   [*] Unique objective attempt
        -   [ ] Objective met
        -   Grader comments: The YAML header contains basic elements like title, format, author, and date. 
                However, for an APA-styled document, it lacks specific APA formatting settings which typically include things like `apa`, `csl`, and more. 
...
I believe that I have completed unassessed objectives 1, 
...
I learnt to write for and while loops. I found while loops combined with if {} else {} arguments difficult to run, especially when I try to get a function recognize if an input year is a leap year and if not, then output how many more years are needed to reach a leap year. With my TA's suggestions, I separated the conditional statement from the loop. Then the logic became clearer.

I think that next time rather than debugging for 6 hours straight while still not finding a clue, I need to reach out for help earlier, and try to modify my method. 

<!-- Reflection below this line -->
I met unassessed objective 1 by using comments throughout the document to explain my basic steps. 
I met unassessed objective 8 by including a for loop and a while loop.
...
-   TA provisional engagement points (up to 10): 4 (Lisa has been going to my office hours)
-   Final approved engagement points (up to 10):
-   Total points (up to 50): 11
